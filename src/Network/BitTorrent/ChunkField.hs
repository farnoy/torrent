...
getNextChunk cf@(ChunkField missing requested) = go (IntSet.null missing)
...
markCompleted cf@(ChunkField missing requested) (ChunkId ix) =
...
markRequested cf@(ChunkField missing requested) (ChunkId ix) =
...
markMissing cf@(ChunkField missing requested) (ChunkId ix) =
...
isCompleted (ChunkField missing requested) =
...
isRequested (ChunkField missing _) = IntSet.null missing
